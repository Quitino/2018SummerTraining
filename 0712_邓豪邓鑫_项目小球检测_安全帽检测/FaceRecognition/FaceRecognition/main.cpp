...
int main()
{
	...
	while (1)                  //循环显示每一帧
	{
		...
		if (!eye_Classifier.load("C://Users//Administrator//Desktop//培训//0712//FaceRecognitionhaarcascade_eye.xml"))  //需要将xml文档放在自己指定的路径下
		{
			cout << "Load haarcascade_eye.xml failed!" << endl;
			return 0;
		}

		if (!face_cascade.load("C://Users//Administrator//Desktop//培训//0712//FaceRecognitionhaarcascade_frontalface_alt.xml"))
		{
