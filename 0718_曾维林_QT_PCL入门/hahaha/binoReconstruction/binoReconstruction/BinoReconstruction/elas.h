...
public:
  ...
  void StereoElas( const Mat& left, const Mat& right,Mat& disp_left,Mat& disp_right );

  void operator()( InputArray left, InputArray right,OutputArray disp_left,OutputArray disp_right);
